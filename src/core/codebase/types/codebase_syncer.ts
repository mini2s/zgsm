...
export const SyncServiceService = {
	...
	registerSync: {
		...
		requestSerialize: (value: RegisterSyncRequest) => Buffer.from(RegisterSyncRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer) => RegisterSyncRequest.decode(value),
		responseSerialize: (value: RegisterSyncResponse) => Buffer.from(RegisterSyncResponse.encode(value).finish()),
		responseDeserialize: (value: Buffer) => RegisterSyncResponse.decode(value),
	},
	...
	unregisterSync: {
		...
		requestStream: false,
		responseStream: false,
		requestSerialize: (value: UnregisterSyncRequest) => Buffer.from(UnregisterSyncRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer) => UnregisterSyncRequest.decode(value),
	...
	shareAccessToken: {
		...
		requestStream: false,
		responseStream: false,
		requestSerialize: (value: ShareAccessTokenRequest) =>
			Buffer.from(ShareAccessTokenRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer) => ShareAccessTokenRequest.decode(value),
		responseSerialize: (value: ShareAccessTokenResponse) =>
